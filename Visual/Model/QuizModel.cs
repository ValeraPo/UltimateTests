...
namespace Visual.Model
{
    internal class QuizModel : INotifyPropertyChanged
    {
        ...
        public QuizModel() { }
        public QuizModel(string nameQuiz, TimeSpan timeToComplite, int max, ObservableCollection<QuestionModel> questions, ObservableCollection<string> tags,
                         ObservableCollection<FeedbackModel> feedbacks, ObservableCollection<AnswerModel> correctAnswers)
        {
            _nameQuiz       = nameQuiz;
